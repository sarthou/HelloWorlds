...
namespace hws::physx {
  ...
  Actor::Actor(hws::physx::Context& ctx,
               const hws::Shape& collision_shape,
               const std::vector<hws::Shape>& visual_shapes) : hws::Actor(collision_shape, visual_shapes),
                                                               ctx_(ctx)
  {}
  ...
  void Actor::setupPhysicsShape(const hws::ShapeBox& shape)
  {
  ...
  void Actor::setupPhysicsShape(const hws::ShapeCapsule& shape)
  {
  ...
  static ::physx::PxTriangleMesh* createPxTriangleMesh(const hws::Mesh& mesh,
  ...
  void Actor::setupPhysicsShape(const hws::ShapeCustomMesh& shape)
  {
  ...
  void Actor::setupPhysicsShape(const hws::ShapeCylinder& shape)
  {
    setupPhysicsShape(hws::ShapeCustomMesh{
  ...
  void Actor::setupPhysicsShape(const hws::ShapeDummy& shape)
  {
    (void)shape;
  }

  void Actor::setupPhysicsShape(const hws::ShapeSphere& shape)
  {
