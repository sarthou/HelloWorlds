...
namespace hws::physx {
  ...
  std::unique_ptr<hws::physx::SharedContext>& Context::createContext()
  {
    static std::unique_ptr<hws::physx::SharedContext> shared_ctx_ = std::make_unique<SharedContext>("0.0.0.0");
