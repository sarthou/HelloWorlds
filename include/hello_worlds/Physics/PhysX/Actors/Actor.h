...
namespace hws::physx {
  ...
  public:
    ...
    hws::AABB_t getAABB() override;
    hws::AABB_t getLocalAABB() override;
    ...
    void setupPhysicsShape(const hws::ShapeBox& shape);
    void setupPhysicsShape(const hws::ShapeCapsule& shape);
    void setupPhysicsShape(const hws::ShapeCustomMesh& shape);
    void setupPhysicsShape(const hws::ShapeCylinder& shape);
    void setupPhysicsShape(const hws::ShapeDummy& shape);
    void setupPhysicsShape(const hws::ShapeSphere& shape);
  ...
  protected:
    ...
    // std::vector<hws::Shape> visual_shapes_;
