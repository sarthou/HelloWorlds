#ifndef HWS_COMMON_VISUALACTOR_H
#define HWS_COMMON_VISUALACTOR_H
...
namespace hws {
  ...
  {
  public:
    explicit VisualActor(const std::vector<hws::Shape>& visual_shapes);

    ~VisualActor() noexcept override = default;
...
#endif // HWS_COMMON_VISUALACTOR_H
