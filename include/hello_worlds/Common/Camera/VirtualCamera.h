#ifndef HWS_VIRTUALCAMERA_H
#define HWS_VIRTUALCAMERA_H
...
namespace hws {
  ...
  {
  public:
    VirtualCamera(unsigned int width, unsigned int height, float fov, hws::CameraView_e view_type, float near_plane, float far_plane);
    ~VirtualCamera();
